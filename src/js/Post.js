        ...
        <div className="post">
            <div className="post__header">
                ...
                >
                    <h3>{username} </h3>
                    <Avatar
                        className="post__postType"
                        alt={username}
                        src={
                            postType === "G"
                                ? "resources/logo/logo_giver.svg"
                                : "resources/logo/logo_taker.svg"
                        }
                        onClick={viewtheirstuff.bind(this, username)}
                    />
                </div>
            ...
            <h4 className="post__text breakfix">
                {caption && ( // Only if the caption field is NOT empty, display it along with the user name
                    <Linkify componentDecorator={componentDecorator}>
                        <strong onClick={viewtheirstuff.bind(this, username)}>
                            {username}:{" "}
                        </strong>
                        {caption}
                    </Linkify>
            ...
            {user && ( // Only display this comment form input if the user has logged in
                <form className="post__commentBox">
                    <Textarea
                        ...
                        type="text"
                        placeholder={
                            lang ? "Ajoutez un commentaire" : "Add a comment"
                        }
                        value={comment}
